...
if __name__ == "__main__":
    ...
    PERMUTATIONIMPORTANCESPATHTRAININGSET = "results_model_analysis_3/0_training_set.pkl"
    PERMUTATIONIMPORTANCESPATHTESTSET = "results_model_analysis_3/0_test_set.pkl"
