...
if __name__ == "__main__":
    ...
    MODELPATH = "histology_classification_models/9.pkl"
    
    ACCEPTANCETHRESHOLD = None
    
    METHODPREDICTION = "soft"
    ...
    FOLDERRESULTINGIMAGESTESTSET = "./results_classification_images_6"
    STATISTICSPATH = "./statistics_classification_6.txt"
    FOLDERDATAFRAME = "./results_classification_dataframes_6"
