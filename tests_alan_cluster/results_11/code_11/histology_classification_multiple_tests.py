...
if __name__ == "__main__":
    ...
    #CLASSESEQUALIZATIONLIST = [("anticipated_random_under_sampler", {"random_state" : RANDOMSTATE})]
    #CLASSESEQUALIZATIONLIST = [(None, dict())]
    
    
    CLASSESEQUALIZATIONLIST = []
    
    """
    CLASSESEQUALIZATIONLIST.append((None, dict()))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.ClusterCentroids, {"random_state" : RANDOMSTATE, "voting" : "soft"}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.ClusterCentroids, {"random_state" : RANDOMSTATE, "voting" : "hard"}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.CondensedNearestNeighbour, {"sampling_strategy" : "auto", "random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.CondensedNearestNeighbour, {"sampling_strategy" : "all", "random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.EditedNearestNeighbours, {"sampling_strategy" : "auto", "kind_sel" : "all", "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.EditedNearestNeighbours, {"sampling_strategy" : "auto", "kind_sel" : "mode", "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.EditedNearestNeighbours, {"sampling_strategy" : "all", "kind_sel" : "all", "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.EditedNearestNeighbours, {"sampling_strategy" : "all", "kind_sel" : "mode", "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.InstanceHardnessThreshold, {"estimator" : sklearn.ensemble.RandomForestClassifier(n_estimators = 500, max_features = "sqrt", min_samples_leaf = 10, n_jobs = -1, random_state = RANDOMSTATE), "random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.NearMiss, {"version" : 1, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.NearMiss, {"version" : 2, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.NearMiss, {"version" : 3, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.RandomUnderSampler, {"random_state" : RANDOMSTATE}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.TomekLinks, {"sampling_strategy" : "auto", "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.under_sampling.TomekLinks, {"sampling_strategy" : "all", "n_jobs" : -1}))
    """
    #CLASSESEQUALIZATIONLIST.append((imblearn.over_sampling.ADASYN, {"random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.over_sampling.BorderlineSMOTE, {"kind" : "borderline-1", "random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.over_sampling.BorderlineSMOTE, {"kind" : "borderline-2", "random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.over_sampling.RandomOverSampler, {"random_state" : RANDOMSTATE}))
    CLASSESEQUALIZATIONLIST.append((imblearn.over_sampling.SMOTE, {"random_state" : RANDOMSTATE, "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.combine.SMOTEENN, {"random_state" : RANDOMSTATE, "smote" : imblearn.over_sampling.SMOTE(random_state = RANDOMSTATE, n_jobs = -1), "enn" : imblearn.under_sampling.EditedNearestNeighbours(sampling_strategy = "auto", kind_sel = "all", n_jobs = -1), "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.combine.SMOTEENN, {"random_state" : RANDOMSTATE, "smote" : imblearn.over_sampling.SMOTE(random_state = RANDOMSTATE, n_jobs = -1), "enn" : imblearn.under_sampling.EditedNearestNeighbours(sampling_strategy = "auto", kind_sel = "mode", n_jobs = -1), "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.combine.SMOTEENN, {"random_state" : RANDOMSTATE, "smote" : imblearn.over_sampling.SMOTE(random_state = RANDOMSTATE, n_jobs = -1), "enn" : imblearn.under_sampling.EditedNearestNeighbours(sampling_strategy = "all", kind_sel = "all", n_jobs = -1), "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.combine.SMOTEENN, {"random_state" : RANDOMSTATE, "smote" : imblearn.over_sampling.SMOTE(random_state = RANDOMSTATE, n_jobs = -1), "enn" : imblearn.under_sampling.EditedNearestNeighbours(sampling_strategy = "all", kind_sel = "mode", n_jobs = -1), "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.combine.SMOTETomek, {"random_state" : RANDOMSTATE, "smote" : imblearn.over_sampling.SMOTE(random_state = RANDOMSTATE, n_jobs = -1), "tomek" : imblearn.under_sampling.TomekLinks(sampling_strategy = "auto", n_jobs = -1), "n_jobs" : -1}))
    CLASSESEQUALIZATIONLIST.append((imblearn.combine.SMOTETomek, {"random_state" : RANDOMSTATE, "smote" : imblearn.over_sampling.SMOTE(random_state = RANDOMSTATE, n_jobs = -1), "tomek" : imblearn.under_sampling.TomekLinks(sampling_strategy = "all", n_jobs = -1), "n_jobs" : -1}))
    
    
    FEATURESELECTIONLIST = [(None, dict())]
    ...
    MODELALGORITHMLIST = [(sklearn.ensemble.RandomForestClassifier, {"n_estimators" : 500, "max_features" : "sqrt", "min_samples_leaf" : 10, "n_jobs" : -1, "random_state" : RANDOMSTATE})]
    #MODELALGORITHMLIST = [(sklearn.ensemble.RandomForestClassifier, {"n_estimators" : 500, "max_features" : "sqrt", "min_samples_leaf" : 10, "class_weight" : "balanced_subsample", "n_jobs" : -1, "random_state" : RANDOMSTATE})]
    
    
    #TESTPARAMETERSLIST = [("voting_hard", None)]
    #TESTPARAMETERSLIST = [("hard", None), ("soft", None)]
    ...
    #WIDTHSUBWINDOW = 3
    #HEIGHTSUBWINDOW = 3
    #METHODSUBWINDOW = "subwindow_multioutput"
    
    #SUBWINDOWPARAMETERSLIST = [(None, 1, 1, True, True), ("subwindow_center", 3, 3, True, True), ("subwindow_center", 5, 5, True, True), ("subwindow_multioutput", 1, 1, True, True), ("subwindow_multioutput", 3, 3, True, True), ("subwindow_center", 1, 1, True, True)]
    SUBWINDOWPARAMETERSLIST = [(None, 1, 1, True, True)]
    
    
    IDMODELBEGIN = 16
    
    FOLDERMODELS = "./histology_classification_models"
