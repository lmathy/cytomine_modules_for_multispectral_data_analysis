...
if __name__ == "__main__":
    ...
    while i <= 50:
        ...
        while j <= 50:
            ...
            tupleToAdd = (sklearn.ensemble.ExtraTreesClassifier, {"n_estimators" : 500, "max_features" : i, "min_samples_leaf" : j, "n_jobs" : -1, "random_state" : 0})
    ...
    while j <= 50:
        ...
        tupleToAdd = (sklearn.ensemble.ExtraTreesClassifier, {"n_estimators" : 500, "max_features" : None, "min_samples_leaf" : j, "n_jobs" : -1, "random_state" : 0})
        modelAlgorithmList.append(tupleToAdd)
