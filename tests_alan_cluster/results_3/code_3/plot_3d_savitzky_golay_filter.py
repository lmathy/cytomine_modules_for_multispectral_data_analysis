...
if __name__ == "__main__":
    ...
    scatterPlot = ax.scatter3D(smoothingPointsPlot, orderPolynomialFitPlot, orderDerivativePlot, c = metricValues, cmap = "viridis")
    
    ax.set_xlabel("number of smoothing points")
    ax.set_ylabel("polynomial order")
    ax.set_zlabel("derivative order")
