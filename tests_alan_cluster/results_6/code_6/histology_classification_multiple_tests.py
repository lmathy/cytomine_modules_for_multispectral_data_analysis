...
if __name__ == "__main__":
    ...
    NOISEREDUCTIONLIST = [("sklearn_pca", True, {"random_state" : RANDOMSTATE}), (None, True, dict())]
    ...
    INTERVALSTOSELECTLIST = [numpy.array([[1000, 1350], [1490, 1800]]), None]
    NORMALISELIST = [True, False]
    METHODSAVITZKYGOLAYFILTERLIST = ["savitzky_golay_filter", None]
