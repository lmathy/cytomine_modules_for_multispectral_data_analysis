...
if __name__ == "__main__":
    ...
    NOISEREDUCTIONLIST = [("sklearn_pca", True, {"random_state" : RANDOMSTATE})]
    ...
    INTERVALSTOSELECTLIST = [numpy.array([[1000, 1350], [1490, 1800]])]
    NORMALISELIST = [True]
    ...
    MODELALGORITHMLIST = [(sklearn.ensemble.RandomForestClassifier, {"n_estimators" : NUMBERESTIMATORS, "max_features" : MAXIMUMFEATURES, "min_samples_leaf" : MINIMUMSAMPLESPERLEAF, "n_jobs" : NUMBERJOBS, "random_state" : RANDOMSTATE})]
    """
    ...
    while i <= 50:
        ...
        while j <= 50:
            ...
            tupleToAdd = (sklearn.ensemble.RandomForestClassifier, {"n_estimators" : 500, "max_features" : i, "min_samples_leaf" : j, "n_jobs" : -1, "random_state" : RANDOMSTATE})
    ...
    while j <= 50:
        ...
        tupleToAdd = (sklearn.ensemble.RandomForestClassifier, {"n_estimators" : 500, "max_features" : None, "min_samples_leaf" : j, "n_jobs" : -1, "random_state" : RANDOMSTATE})
        MODELALGORITHMLIST.append(tupleToAdd)
