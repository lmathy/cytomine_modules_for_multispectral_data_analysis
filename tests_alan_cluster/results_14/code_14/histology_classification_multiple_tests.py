...
if __name__ == "__main__":
    ...
    for numberEstimators in numpy.arange(1, 101, 1):
        MODELALGORITHMLIST.append((sklearn.ensemble.RandomForestClassifier, {"n_estimators" : numberEstimators, "max_features" : "sqrt", "min_samples_leaf" : 10, "n_jobs" : -1, "random_state" : RANDOMSTATE}))
    
    for numberEstimators in numpy.arange(1, 101, 1):
        MODELALGORITHMLIST.append((sklearn.ensemble.ExtraTreesClassifier, {"n_estimators" : numberEstimators, "max_features" : "sqrt", "min_samples_leaf" : 10, "n_jobs" : -1, "random_state" : RANDOMSTATE}))
    
    """
    for numberEstimators in numpy.arange(1, 51, 1):
        MODELALGORITHMLIST.append((imblearn.ensemble.BalancedRandomForestClassifier, {"n_estimators" : numberEstimators, "max_features" : "sqrt", "min_samples_leaf" : 10, "n_jobs" : -1, "random_state" : RANDOMSTATE}))
    
    for numberEstimators in numpy.arange(1, 51, 1):
        MODELALGORITHMLIST.append((imblearn.ensemble.BalancedRandomForestClassifier, {"n_estimators" : numberEstimators, "max_features" : "sqrt", "min_samples_leaf" : 10, "n_jobs" : -1, "random_state" : RANDOMSTATE, "bootstrap" : False}))
    """
