...
if __name__ == "__main__":
    ...
    TREEINTERPRETERPATH = "./results_model_analysis/tree_interpreter_results.pkl"
    
    PERMUTATIONIMPORTANCESLIST = [({"scoring" : "f1_weighted", "n_repeats" : 5, "n_jobs" : -1, "random_state" : RANDOMSTATE}, imblearn.under_sampling.RandomUnderSampler, {"random_state" : RANDOMSTATE})]
